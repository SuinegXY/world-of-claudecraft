...
describe('delta-key contract pins (anti-drift)', () => {
  it('ALL_DELTA_KEYS contains exactly 84 unique keys in sorted order', () => {
    ...
    // retirement then removes sport/vcup/vcupb, for 83, then exclusive
    // versatility rating `vrat` for 84.
  ...
  it('ALL_DELTA_KEYS equals the maybe(...) keys scraped from server/game.ts (multi-line lockouts incl.)', () => {
    ...
    // The Vale Cup retirement then removes sport/vcup/vcupb, for 83, then
    // exclusive versatility rating `vrat` for 84.
