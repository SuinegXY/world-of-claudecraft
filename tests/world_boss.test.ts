...
describe('world boss personal loot', () => {
  ...
  it(
    'rolls exclusive secondary affixes onto personal gear drops (not junk trophies)',
    () => {
      let sawGear = false;
      // 0.38 Sim construction is heavier; a short seed sweep still finds gear
      // drops while staying under the gate budget.
