...
export const ZONE2_ITEMS: Record<string, ItemDef> = {
  ...
  deacons_cleaver: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 22, max: 36, speed: 2.4 },
    stats: { str: 20 },
    sellValue: 300,
    requiredClass: WAR,
  },
  ...
  mistbinder_kris: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 14, max: 24, speed: 1.7, dagger: true },
    stats: { agi: 20 },
    sellValue: 300,
    requiredClass: ROG,
  },
  ...
  voss_sanctified_mace: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 24, max: 40, speed: 2.6 },
    stats: { int: 15, spi: 10 },
    sellValue: 420,
    requiredClass: MAG,
  },
  mirejaw_biteblade: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 16, max: 28, speed: 1.7, dagger: true },
    stats: { agi: 25, sta: 10 },
    sellValue: 480,
    requiredClass: ROG,
  },
  ...
  tidereaver_gaff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 34, max: 56, speed: 2.5 },
    stats: { str: 25, sta: 20 },
    sellValue: 1400,
    requiredClass: WAR,
  },
  sloomtooth_tidefang: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 20, max: 34, speed: 1.7, dagger: true },
    stats: { agi: 30, sta: 15 },
    sellValue: 1400,
    requiredClass: ROG,
  },
  drowned_tide_scepter: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 32, max: 56, speed: 3.0 },
    stats: { int: 30, spi: 15 },
    sellValue: 1400,
    requiredClass: MAG,
  },
  ...
  fen_reaver_glaive: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 32, max: 52, speed: 2.4 },
    stats: { str: 25, sta: 15 },
    sellValue: 1400,
    requiredClass: WAR,
  },
  ...
  mistcallers_edge: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 28, max: 46, speed: 2.3 },
    stats: { str: 20, sta: 15 },
    sellValue: 1200,
    requiredClass: WAR,
  },
  vaels_mist_staff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 30, max: 52, speed: 3.0 },
    stats: { int: 30, spi: 15 },
    sellValue: 1200,
    requiredClass: CASTER_WEAPON_CLASSES,
  },
  riptide_dirk: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 18, max: 30, speed: 1.7, dagger: true },
    stats: { agi: 25, sta: 10 },
    sellValue: 1200,
    requiredClass: ROG,
  },
  ...
  bogiron_mace: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 16, max: 28, speed: 2.6 },
    sellValue: 250,
    buyValue: 2500,
  },
  fenreed_staff: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 18, max: 32, speed: 3.0 },
    stats: { int: 5 },
    sellValue: 250,
    buyValue: 2500,
  },
  mirefen_skinner: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 12, max: 20, speed: 1.8, dagger: true },
    sellValue: 250,
    buyValue: 2500,
  },
  bogiron_hauberk: {
  ...
  fenshadow_maul: {
    ...
    weapon: { min: 70, max: 96, speed: 3.4 },
    stats: { str: 15, agi: 10, sta: 10 },
    sellValue: 420,
    requiredClass: FERAL,
  },
};
