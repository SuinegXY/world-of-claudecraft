...
export const BASE_ITEMS: Record<string, ItemDef> = {
  ...
  rusty_dagger: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 4, max: 8, speed: 1.8, dagger: true },
    sellValue: 10,
  },
  training_mace: {
    id: 'training_mace',
  ...
  redbrook_blade: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 12, max: 22, speed: 2.2 },
    stats: { str: 10 },
    sellValue: 120,
    requiredClass: WAR,
  },
  apprentice_staff: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 14, max: 24, speed: 3.0 },
    stats: { int: 15, sta: 5 },
    sellValue: 120,
  ...
  keen_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 8, max: 16, speed: 1.7, dagger: true },
    stats: { agi: 10 },
    sellValue: 120,
    requiredClass: ROG,
  },
  ...
  bristleback_maul: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 14, max: 24, speed: 2.8 },
    stats: { str: 10, sta: 5 },
    sellValue: 160,
    requiredClass: WAR,
  },
  ...
  tunnelkings_spade: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 18, max: 30, speed: 2.7 },
    stats: { str: 15, sta: 10 },
    sellValue: 190,
    requiredClass: WAR,
  },
  ...
  moggers_shiv: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 12, max: 22, speed: 1.7, dagger: true },
    stats: { agi: 20, sta: 10 },
    sellValue: 850,
    requiredClass: ROG,
  },
  valeborn_spellblade: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 16, max: 28, speed: 2.2 },
    stats: { int: 20, spi: 10 },
    sellValue: 850,
    requiredClass: MAG,
  },
  ...
  eastbrook_arming_sword: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 10, max: 18, speed: 2.2 },
    sellValue: 140,
    buyValue: 1400,
  },
  eastbrook_greatsword: {
    ...
    hand: 'twohand',
    quality: 'common',
    weapon: { min: 18, max: 30, speed: 3.4 },
    sellValue: 160,
    buyValue: 1600,
  },
  bronzework_mace: {
  ...
  vale_carving_knife: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 8, max: 14, speed: 1.8, dagger: true },
    sellValue: 120,
    buyValue: 1200,
  },
  hickory_shortstaff: {
    ...
    slot: 'mainhand',
    quality: 'common',
    weapon: { min: 12, max: 22, speed: 3.0 },
    stats: { int: 5 },
    sellValue: 150,
    buyValue: 1500,
  },
  ...
  gravecaller_blade: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 18, max: 32, speed: 2.4 },
    stats: { str: 20, sta: 15 },
    sellValue: 800,
  },
  widowfang_dirk: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 12, max: 20, speed: 1.7, dagger: true },
    stats: { agi: 20, sta: 15 },
    sellValue: 800,
  },
  gravecaller_staff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 20, max: 34, speed: 3.0 },
    stats: { int: 25, spi: 10 },
    sellValue: 800,
  },
  marrowtread_boots: {
  ...
  hollow_vigil_staff: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 22, max: 36, speed: 3.0 },
    stats: { int: 25, spi: 10 },
    sellValue: 880,
    requiredClass: CASTER_WEAPON_CLASSES,
  },
  ...
  briarroot_staff: {
    ...
    weapon: { min: 58, max: 80, speed: 3.3 },
    stats: { str: 10, sta: 10 },
    sellValue: 320,
    requiredClass: FERAL,
  },
  ...
  monarch_crown_helm: {
    ...
    slot: 'helmet',
    quality: 'rare',
    stats: { armor: 230, sta: 15, agi: 10, str: 5 },
    sellValue: 320,
  },
  // --- junk (gray) ---
  ...
  gorraks_cleaver: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 16, max: 28, speed: 2.5 },
    stats: { str: 15 },
    sellValue: 180,
    requiredClass: WAR,
  },
  ...
  tradesman_hatchet: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 14, max: 26, speed: 2.3 },
    stats: { str: 5, sta: 5 },
    sellValue: 160,
  },
  drovers_staff: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 18, max: 30, speed: 3.0 },
    stats: { int: 15, spi: 10 },
    sellValue: 175,
    requiredClass: CASTER_WEAPON_CLASSES,
  },
  caravan_warden_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 10, max: 18, speed: 1.7, dagger: true },
    stats: { agi: 15 },
    sellValue: 170,
    requiredClass: ROG,
  },
