...
export const TEMPLE_ITEMS: Record<string, ItemDef> = {
  ...
  moonscale_saber: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 34, max: 56, speed: 2.4 },
    stats: { str: 25, sta: 10 },
    sellValue: 700,
    requiredClass: WAR,
  },
  palecoil_rod: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 36, max: 62, speed: 3.0 },
    stats: { int: 30, spi: 10 },
    sellValue: 700,
    requiredClass: MAG,
  },
  tideglass_dirk: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 22, max: 36, speed: 1.7, dagger: true },
    stats: { agi: 30 },
    sellValue: 700,
    requiredClass: ROG,
  },
  ...
  drownedmoon_maul: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 48, max: 76, speed: 2.6 },
    stats: { str: 40, sta: 20 },
    sellValue: 2200,
    requiredClass: WAR,
  },
  drownedmoon_scepter: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 52, max: 84, speed: 3.0 },
    stats: { int: 50, spi: 20 },
    sellValue: 2200,
    requiredClass: MAG,
  },
  drownedmoon_kris: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 32, max: 50, speed: 1.7, dagger: true },
    stats: { agi: 45, sta: 15 },
    sellValue: 2200,
    requiredClass: ROG,
  },
  moonshroud_breastplate: {
    ...
    slot: 'chest',
    quality: 'rare',
    stats: { armor: 1000, sta: 35, str: 20 },
    sellValue: 2400,
    requiredClass: WAR,
  },
  moonshroud_robe: {
  ...
  pearlward_aegis: {
    ...
    // requiredClass list.
    blockValue: 12,
    stats: { armor: 1200, int: 25, spi: 15 },
    sellValue: 1700,
