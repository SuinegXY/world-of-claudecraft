...
export const DELVE_ITEMS: Record<string, ItemDef> = {
  ...
  nhalias_bell_maul: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 76, max: 116, speed: 3.5 },
    stats: { str: 15, sta: 10 },
    sellValue: 560,
    requiredClass: WAR,
  },
  ...
  mirejaw_fang_knife: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 28, max: 44, speed: 1.8, dagger: true },
    stats: { agi: 10 },
    sellValue: 200,
    requiredClass: ROG,
  },
  ...
  corpse_candle_focus: {
    ...
    slot: 'mainhand',
    quality: 'uncommon',
    weapon: { min: 18, max: 30, speed: 2.0 },
    stats: { int: 10, spi: 10 },
    sellValue: 195,
    requiredClass: MAG,
  },
  nhalias_litany_rod: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 36, max: 60, speed: 3.2 },
    stats: { int: 20, spi: 10 },
    sellValue: 550,
    requiredClass: MAG,
  },
  ...
  blackwater_vanguard_chest: {
    ...
    slot: 'chest',
    quality: 'epic',
    stats: { armor: 1100, str: 45, sta: 40 },
    sellValue: 5000,
    requiredClass: WAR,
  },
  siltstep_leggings: {
  ...
  drowned_choir_fang: {
    ...
    slot: 'mainhand',
    quality: 'rare',
    weapon: { min: 40, max: 64, speed: 1.7, dagger: true },
    stats: { agi: 20, sta: 15 },
    sellValue: 620,
    requiredClass: ROG,
  },
