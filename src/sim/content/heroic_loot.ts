...
export const HEROIC_ITEMS: Record<string, ItemDef> = {
  ...
  morthens_cryptforged_hauberk: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1675, str: 60, sta: 50 },
  ...
  cryptplate_helm: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1460, str: 50, sta: 40 },
    hitRating: ARMOR_RATING,
    sellValue: 12000,
    requiredClass: HEAVY,
  },
  ...
  mistcallers_fang: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 44, max: 72, speed: 1.8, dagger: true },
    stats: { agi: 65, sta: 45 },
  ...
  mistforged_pauldrons: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1200, str: 45, sta: 35 },
    critRating: ARMOR_RATING,
    sellValue: 11000,
    requiredClass: HEAVY,
  },
  ...
  lunar_tide_greatstaff: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 72, max: 120, speed: 3.0 },
    stats: { int: 65, spi: 45 },
  ...
  choirmothers_casque: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1460, int: 50, spi: 40 },
    hasteRating: ARMOR_RATING,
    sellValue: 12000,
  ...
  choir_blessed_spaulders: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1200, int: 45, spi: 35 },
    critRating: ARMOR_RATING,
    sellValue: 11000,
    requiredClass: HEAL_MAIL,
  },
  tideworn_warboots: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1060, str: 40, sta: 30 },
    hitRating: ARMOR_RATING,
    sellValue: 9500,
    requiredClass: HEAVY,
  },
  ...
  gravewyrm_cleaver: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 62, max: 104, speed: 2.6 },
    stats: { str: 65, sta: 45 },
    critRating: FIVE_MAN_WEAPON_RATING,
    sellValue: 15000,
    requiredClass: HEAVY,
  ...
  gravewyrm_claws: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1120, str: 45, sta: 30 },
    critRating: ARMOR_RATING,
    sellValue: 9500,
    requiredClass: HEAVY,
  },
  ...
  wyrmchoir_handwraps: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1120, int: 45, spi: 30 },
    hasteRating: ARMOR_RATING,
    sellValue: 9500,
    requiredClass: HEAL_MAIL,
  },
  ...
  stormbark_mantle: {
    ...
    stats: { armor: 740, int: 45, spi: 25, sta: 10 },
    critRating: ARMOR_RATING,
    sellValue: 11000,
    requiredClass: HEAL_LEATHER,
  },
  wildsoul_maul: {
    ...
    weapon: { min: 110, max: 156, speed: 3.6 },
    stats: { str: 65, agi: 45, sta: 35 },
    hitRating: FIVE_MAN_WEAPON_RATING,
    sellValue: 15000,
    requiredClass: FERAL,
  },
  ...
  scepter_of_the_deathless_court: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 58, max: 102, speed: 2.4 },
    stats: { int: 65, spi: 50 },
  ...
  deathless_greatblade: {
    ...
    weapon: { min: 104, max: 156, speed: 3.4 },
  ...
  stormcallers_focus: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    weapon: { min: 62, max: 104, speed: 2.5 },
    stats: { int: 70, spi: 45 },
    hasteRating: RAID_WEAPON_PRIMARY_RATING,
    critRating: RAID_SECONDARY_RATING,
    sellValue: 16000,
...
export const RETIRED_HEROIC_ITEMS: Record<string, ItemDef> = {
  deathless_warguard_legmail: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1575, str: 55, sta: 45 },
    sellValue: 13000,
    requiredClass: HEAVY,
  },
  soulrend_diadem: {
  ...
  soulforged_warplate: {
    ...
    quality: 'epic',
    requiredLevel: 20,
    stats: { armor: 1675, int: 60, spi: 50 },
    sellValue: 14000,
    requiredClass: HEAL_MAIL,
  },
};
