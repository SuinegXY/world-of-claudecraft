...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  warrior: {
    id: 'warrior',
    name: 'Warrior',
    baseStats: { str: 46, agi: 40, sta: 44, int: 20, spi: 22, armor: 100 },
    statsPerLevel: { str: 4, agi: 2, sta: 4, int: 0, spi: 0, armor: 24 },
    baseHp: 100,
    hpPerLevel: 36,
    baseMana: 200, // rage cap
    manaPerLevel: 0,
    resourceType: 'rage',
  ...
  mage: {
    id: 'mage',
    name: 'Mage',
    baseStats: { str: 20, agi: 24, sta: 28, int: 48, spi: 44, armor: 50 },
    statsPerLevel: { str: 0, agi: 0, sta: 2, int: 6, spi: 4, armor: 8 },
    baseHp: 80,
    hpPerLevel: 24,
    baseMana: 200,
    manaPerLevel: 48,
    ...
    ranged: { min: 6, max: 12, speed: 1.8, maxRange: 30, minRange: 0, wand: true, school: 'arcane' },
    abilities: [
      'fireball',
      'frost_armor',
      'arcane_intellect',
  ...
  rogue: {
    id: 'rogue',
    name: 'Rogue',
    baseStats: { str: 34, agi: 50, sta: 34, int: 22, spi: 24, armor: 80 },
    statsPerLevel: { str: 2, agi: 6, sta: 2, int: 0, spi: 0, armor: 16 },
    baseHp: 90,
    hpPerLevel: 30,
    baseMana: 200, // energy cap
    manaPerLevel: 0,
    resourceType: 'energy',
  ...
  paladin: {
    id: 'paladin',
    name: 'Paladin',
    baseStats: { str: 44, agi: 34, sta: 44, int: 26, spi: 28, armor: 90 },
    statsPerLevel: { str: 4, agi: 2, sta: 4, int: 2, spi: 2, armor: 24 },
    baseHp: 110,
    hpPerLevel: 34,
    baseMana: 160,
    manaPerLevel: 40,
  ...
  hunter: {
    id: 'hunter',
    name: 'Hunter',
    baseStats: { str: 28, agi: 50, sta: 38, int: 26, spi: 28, armor: 90 },
    statsPerLevel: { str: 2, agi: 6, sta: 4, int: 2, spi: 2, armor: 16 },
    baseHp: 100,
    hpPerLevel: 30,
    baseMana: 160,
    manaPerLevel: 36,
    ...
    startChest: 'footpad_jerkin',
    startItems: START_RATIONS_MANA,
    ranged: { min: 10, max: 18, speed: 2.3, maxRange: 35, minRange: 8 },
    abilities: [
      'raptor_strike',
      'aspect_of_the_hawk',
      'serpent_sting',
  ...
  priest: {
    id: 'priest',
    name: 'Priest',
    baseStats: { str: 20, agi: 22, sta: 26, int: 44, spi: 48, armor: 40 },
    statsPerLevel: { str: 0, agi: 0, sta: 2, int: 4, spi: 6, armor: 8 },
    baseHp: 76,
    hpPerLevel: 22,
    baseMana: 220,
    manaPerLevel: 52,
    ...
    startChest: 'apprentice_robe',
    startItems: START_RATIONS_MANA,
    ranged: { min: 6, max: 12, speed: 1.8, maxRange: 30, minRange: 0, wand: true, school: 'holy' },
    abilities: [
      'smite',
      'lesser_heal',
  ...
  shaman: {
    id: 'shaman',
    name: 'Shaman',
    baseStats: { str: 36, agi: 32, sta: 40, int: 36, spi: 36, armor: 80 },
    statsPerLevel: { str: 2, agi: 2, sta: 4, int: 4, spi: 4, armor: 20 },
    baseHp: 96,
    hpPerLevel: 30,
    baseMana: 180,
    manaPerLevel: 44,
  ...
  warlock: {
    id: 'warlock',
    name: 'Warlock',
    baseStats: { str: 22, agi: 24, sta: 30, int: 42, spi: 42, armor: 44 },
    statsPerLevel: { str: 0, agi: 0, sta: 2, int: 6, spi: 4, armor: 8 },
    baseHp: 84,
    hpPerLevel: 24,
    baseMana: 210,
    ...
    startChest: 'apprentice_robe',
    startItems: START_RATIONS_MANA,
    ranged: { min: 6, max: 12, speed: 1.8, maxRange: 30, minRange: 0, wand: true, school: 'shadow' },
    abilities: [
      'shadow_bolt',
      'summon_imp',
      'demon_skin',
  ...
  druid: {
    id: 'druid',
    name: 'Druid',
    baseStats: { str: 30, agi: 30, sta: 34, int: 38, spi: 40, armor: 60 },
    statsPerLevel: { str: 2, agi: 2, sta: 4, int: 4, spi: 4, armor: 12 },
    baseHp: 90,
    hpPerLevel: 26,
    baseMana: 190,
    manaPerLevel: 44,
    ...
    ranged: { min: 6, max: 12, speed: 1.8, maxRange: 30, minRange: 0, wand: true, school: 'nature' },
    abilities: [
      'wrath',
      'healing_touch',
      'mark_of_the_wild',
