...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "versatilityRating": "掉落裝備副屬性中的全能。每10點全能增加1%造成的傷害。",
  ...
  "guide": {
    ...
    "social": {
      ...
      "communityHeading": "在聊天裡找人",
      "communityBody": "想找人一起玩？用 LFG 聊天頻道發組隊請求，用世界或綜合頻道做更大範圍的呼叫，公會事務則走公會聊天。/invite 可以把人拉進小隊，地下城查找器也會為副本自動組隊。組隊與社交都在遊戲內完成。",
