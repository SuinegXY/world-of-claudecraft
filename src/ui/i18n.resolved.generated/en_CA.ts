...
export const en_CA: EnTranslations = {
  ...
  "guide": {
    ...
    "social": {
      ...
      "communityBody": "Looking for players? Use the LFG chat channel for group requests, World or General for broader calls, and Guild chat for your guild. /invite brings someone into your party, and the Dungeon Finder forms groups for dungeon runs. Organized play happens inside the game.",
