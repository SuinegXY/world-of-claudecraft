...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "statInfo": {
      ...
      "desc": {
        ...
        "versatilityRating": "掉落装备副属性中的全能。每10点全能增加1%造成的伤害。",
  ...
  "guide": {
    ...
    "social": {
      ...
      "communityHeading": "在聊天里找人",
      "communityBody": "想找人一起玩？用 LFG 聊天频道发组队请求，用世界或综合频道做更大范围的呼叫，公会事务则走公会聊天。/invite 可以把人拉进小队，地下城查找器也会为副本自动组队。组队与社交都在游戏内完成。",
