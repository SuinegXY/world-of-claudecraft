...
const ITEM_ENTITY_IDS = [
  ...
  'curved_tusk',
  'pristine_claw',
  // Exclusive fashion welfare: Season 1 Armory weapon-skin unlock tokens.
...
const APPENDED_ITEM_NAMES: Partial<Record<ItemEntityId, string>> = {
  ...
  // Exclusive fashion welfare: Season 1 Armory unlock tokens (names lockstep with
  // armorySkinStrings / fashion_welfare_vendor WEAPON_SKIN_UNLOCK_NAMES).
  guildmark_arming_sword_skin_unlock: 'Guildmark Arming Sword',
  brasscap_axe_skin_unlock: 'Brasscap Hatchet',
  tempered_flanged_mace_skin_unlock: 'Tempered Flanged Mace',
  guildmark_dirk_skin_unlock: 'Guildmark Dirk',
  brasscrown_staff_skin_unlock: 'Brasscrown Walking Staff',
  lacquered_wand_skin_unlock: 'Lacquered Rod',
  fletcher_s_guild_bow_skin_unlock: "Fletcher's Guild Bow",
  cinderbrand_sword_skin_unlock: 'Cinderbrand',
  emberbite_axe_skin_unlock: 'Emberbite',
  smoulderfall_mace_skin_unlock: 'Smoulderfall',
  ashspark_dagger_skin_unlock: 'Ashspark Shiv',
  forgeheart_staff_skin_unlock: 'Forgeheart Stave',
  emberwrought_wand_skin_unlock: 'Emberwrought Wand',
  cinderlatch_crossbow_skin_unlock: 'Cinderlatch',
  ice_fang_sword_skin_unlock: 'Ice Fang',
  glaciersplit_axe_skin_unlock: 'Glaciersplit',
  rimecrusher_mace_skin_unlock: 'Rimecrusher',
  frostbite_dagger_skin_unlock: 'Rime Needle',
  hoarfrost_vigil_staff_skin_unlock: 'Hoarfrost Vigil',
  everwinter_wand_skin_unlock: 'Shard of Everwinter',
  winterbite_skin_unlock: 'Winterbite',
  solheim_sword_skin_unlock: 'Solheim, Last Light of the Dawn',
  skyrender_axe_skin_unlock: "Skyrender, the Firmament's Wound",
  starfall_mace_skin_unlock: 'Starfall, Judgment of the Heavens',
  astravyr_dagger_skin_unlock: 'Astravyr, Fang of the Fallen Star',
  cosmarch_staff_skin_unlock: 'Cosmarch, Spire of the Endless Void',
  emberwish_wand_skin_unlock: 'Emberwish, Mote of the Dying Sun',
  encore_bow_skin_unlock: 'Encore, the Second Falling Star',
  meteorlatch_crossbow_skin_unlock: "Meteorlatch, the Sky's Last Judgment",
};
